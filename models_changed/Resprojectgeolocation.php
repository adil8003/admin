...
/**
 * This is the model class for table "resprojectgeolocation".
 *
 * @property integer $id
 ...
 */
class Resprojectgeolocation extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(Resproject::className(), ['resprojectgeolocationid' => 'id']);
    }
}
