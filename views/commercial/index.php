...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h4 class="title">Commercial Project List
                    <!--<form><input type="text" onblur="seacrhCustomer();" name="search" id="search" placeholder="Enter location"></form>-->
                    <span>
                        <div class="btn-group pull-right">
                            <a href="index.php?r=commercial/add" type="button" class="btn btn-info btn-wd btn-fill btn-xs ">Add Proprty</a>
                ...
                <div class="content table-responsive table-full-width">
                    <table class="table table-striped" id="tblCommertial">
                        <thead>
                            <tr>
                                <td>Minimum price:</td>
...
<script src="js/commercial/index.js"></script>
<style>
    .cus-data{
        color: #100e0e;
