                ...
                <h4 class="title">Residential Project Images 
                    <span>
                        <div class="btn-group pull-right">
                            <a href="index.php?r=commercial/" type="button" class="btn btn-info btn-wd btn-fill btn-xs ">Back</a>
                        </div>
                    </span>
                </h4>
                <hr>
                <div class="row"> 
                    ...
                    <div class="col-sm-4 imageScroll">
                        <div id="florplan" class="card">
                            <li>Upload image for <b>Project images</b>.</li>
                            <li>Upload only one image.</li>
                            <div class="card-block">
...
<script src="js/commercial/image.js"></script>
<style>
    .imageScroll{
        /*overflow-y: auto;*/
        height: 300px;
