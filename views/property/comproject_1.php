...
<!--        <li class="nav-item">
            <a class="nav-link" href="#office" role="tab" data-toggle="tab" aria-controls="office">Office</a>
        </li>-->
<!--        <li class="nav-item">
            <a class="nav-link" href="#comcost" role="tab" data-toggle="tab" aria-controls="comcost">Cost</a>
        </li>-->
<!--        <li class="nav-item">
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane" id="project"> <!-- /tab-panel -list -->
            <?= $this->render( 'partial/comproject/project.php', ['objComproject'=> $objComproject,'objComprojectimage' => $objComprojectimage,'objCommercialprojtype' => $objCommercialprojtype] ); ?>
        </div> <!-- /tab-panel owner -->
        <div role="tabpanel" class="tab-pane" id="comcost"> <!-- /tab-panel -list -->
            <?= $this->render( 'partial/comproject/cost.php', ['objComproject'=> $objComproject , 'objComprojectimage' => $objComprojectimage] ); ?>
        </div> <!-- /tab-panel owner -->
        <div role="tabpanel" class="tab-pane" id="office"> <!-- /tab-panel -list -->
            <?= $this->render( 'partial/comproject/office.php', ['objComproject'=> $objComproject,'objComprojectimage' => $objComprojectimage,'objCommercialprojtype' => $objCommercialprojtype,'objComprojectpreferred' => $objComprojectpreferred ,'objComprojectfurnishing' => $objComprojectfurnishing] ); ?>
        </div> <!-- /tab-panel owner -->
        <div role="tabpanel" class="tab-pane" id="amaneties"> <!-- /tab-panel -list -->
         <?= $this->render( 'partial/comproject/amaneties.php', ['objComproject'=> $objComproject,'objComprojectimage' => $objComprojectimage] ); ?>  
