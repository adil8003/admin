        ...
        <div role="tabpanel" class="tab-pane active" id="resprojectactive"> <!-- /tab-panel -resproject -->
            ...
            <table id="tblresprojectactive" onclick="" class="table table-striped table-bordered DataTable" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <td>Location:</td>
                        <td><select class="js-example-basic-multiple form-control" multiple="multiple" id="seachLocation" style="width: 250px">
                                <?php
                                foreach ($objUniquelocation AS $key => $value) {
                                    echo '<option id="location_id" onclick="getLocation();" value=' . $value['location'] . '>' . $value['location'] . '</option>';
                                }
                                ?>
                            </select>
                        </td>
                    ...
                    <tr>
                        <th>Id</th>
                        <th>Name</th>
                        <th  class="js-example-basic-multiple">Location</th>
                        <th>City</th>
                        <th>Pincode</th>
...
<script type="text/javascript">
  ...
  $('#tblresprojectactive').dataTable().yadcf([
