                ...
                <h4 class="title">CRM - Customer List 
                    ...
                    <span>
                        <div class="btn-group pull-right">
                            ...
                            <a href="index.php?r=users/callnow" type="button" class="btn btn-info btn-wd btn-fill btn-xs ">Call Now</a>
                            <a href="index.php?r=users/inactivecustomer" type="button" class="btn btn-info btn-wd btn-fill btn-xs">Inactive Customer</a>
                        </div>
                    </span>
                </h4>
                <hr>
...
<script src="js/user/crm.js"></script>
<style>
    .cus-data{
        color: #100e0e;
