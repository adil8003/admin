    ...
    if (validateFollowupupdate()) {
        alertify.confirm("Are you sure you want update this amenities?",
                function () {
                    ...
                    $.ajax({
                        url: 'index.php?r=resale/updateamenities',
                        async: false,
                        data: obj,
                        type: 'POST',
...
function allAmenities(id) {
    ...
    $.ajax({
        url: "index.php?r=resale/getallamenities",
        async: false,
        data: obj,
        type: 'GET',
        success: function (data) {
    ...
    if (validateFollowup()) {
        alertify.confirm("Are you sure you want add this amenities?",
                function () {
                    ...
                    obj.aname = $('#aname').val();
                    $.ajax({
                        url: 'index.php?r=resale/saveamenities',
                        async: false,
                        data: obj,
                        type: 'POST',
                        success: function (data) {
