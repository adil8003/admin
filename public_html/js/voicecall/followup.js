    ...
    if (validateFollowupupdate()) {
        alertify.confirm("Are you sure you want update this follow up?",
                function () {
                    ...
                    $.ajax({
                        url: 'index.php?r=voicecall/updatefollowup',
                        async: false,
                        data: obj,
                        type: 'POST',
...
function getFollowbycustomerdetaisbyid() {
    ...
    obj.id = crmid;
    $.ajax({
        url: "index.php?r=voicecall/getcustomerdetailsbyid",
        async: false,
        data: obj,
        type: 'GET',
        success: function (data) {
...
function allFollowup(id) {
    ...
    $.ajax({
        url: "index.php?r=voicecall/getallfollowup",
        async: false,
        data: obj,
        type: 'GET',
        success: function (data) {
    ...
    if (validateFollowup()) {
        alertify.confirm("Are you sure you want add this follow up?",
                function () {
                    ...
                    $.ajax({
                        url: 'index.php?r=voicecall/savefollowup',
                        async: false,
                        data: obj,
                        type: 'POST',
                        success: function (data) {
