$(document).ready(function () {
    ...
    $.noConflict()
    $('#tblCommertial').DataTable({
        ajax: "index.php?r=commercial/getallcommercial",
        "iDisplayLength": 5,
        "columns": [
            {"data": "id",
                "render": function (data, type, full, meta) {
                    var htmlAction = '';
                    return '<a href="#"><b id="com_id" onclick="getResidentialprojectDetails(`' + full.id + '`)">' + full.cname + '</b></a>';
                    return htmlAction;
                }
            },
            {"data": "ptype"},
            ...
            {"data": "id",
                "render": function (data, type, full, meta) {
                    var htmlAction = '';
                    htmlAction += '<a href="index.php?r=commercial/edit&amp;id=' + data + '" title="Edit" class="teal-text"   ><i  class="ti-pencil teal-text "></i></a>&nbsp;&nbsp;'
                    htmlAction += '<a href="index.php?r=commercial/amenities&amp;id=' + data + '" title="Features" class="teal-text"  ><i   class="ti-link teal-text "></i></a>&nbsp;&nbsp;'
//                    htmlAction += '<a href="index.php?r=commercial/keylocation&amp;id=' + data + '" title="Key location" class="teal-text"  ><i   class="ti-car teal-text "></i></a>&nbsp;&nbsp;'
                    htmlAction += '<a href="index.php?r=commercial/image&amp;id=' + data + '" title="Image gallery" class="teal-text"  ><i   class="ti-gallery teal-text "></i></a>&nbsp;&nbsp;'
//                    htmlAction += '<a href="index.php?r=commercial/update&amp;id=' + data + '" title="Project update" class="teal-text"  ><i   class="fa fa-link teal-text "></i></a>&nbsp;&nbsp;'
                    return htmlAction;
                }
            }
        ]
    });
    var oTable1 = $('#tblCommertial').dataTable().yadcf([
        {column_number: 2,
    ...
    var table = $('#tblCommertial').DataTable();
...
function getResidentialprojectDetails(com_id) {
    function getPriceinString(digit) {
        var strReturn = digit;
        var lengthNum = digit.length;
        if (lengthNum != 0 && lengthNum != ' ') {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.status == true) {
                ...
                html += '<strong>Project name:-  ' + data.data.cname + '</strong><span><a href="#top" ><i  class="ti-trash teal-text text-danger pull-right"  onclick="hideDetails();" id="editIcon"></i></a></span>';
                html += '</div>';
                html += ' <div class="row">';
