$(document).ready(function () {
    ...
    var myDropzone = new Dropzone("#imageamaneti", {
        url: "index.php?r=commercial/uploadresidentialamenities&id=" + id + "&imgtype=amenities",
...
$(document).ready(function () {
    ...
    var myDropzone = new Dropzone("#florplan", {
        url: "index.php?r=commercial/uploadresidentialflorplan&id=" + id + "&imgtype=florplan",
...
$(document).ready(function () {
    ...
    var myDropzone = new Dropzone("#imageother", {
        url: "index.php?r=commercial/uploadresidentialotherimag&id=" + id + "&imgtype=other",
...
function getResidentialImagebyid(id) {
    ...
    obj.id = id;
    $.ajax({
        url: "index.php?r=commercial/getimages",
        async: false,
        data: obj,
        type: 'POST',
...
function getImageId(imgid) {
    ...
    alertify.confirm("Are you sure you want to delete this image?",
            function () {
                $.ajax({
                    url: "index.php?r=commercial/deleteimage",
                    async: false,
                    data: obj,
                    type: 'POST',
                    success: function (data) {
