...
function createHTML(data) {
    ...
    html += '<strong> Project Name:   <a href="index.php?r=crm/edit&amp;id=' + data.data.id + '">    ' + data.data.pname + ' </a></strong>';
    html += '</div>';
    html += '<p class=" text-danger" style="font-size: 13px;padding:2px">Developer name.:- ' + data.data.dname + '</p>';
    html += '<p class="text-bold" style="font-size: 18px;padding:2px">Price. :- ' + getPriceinString(data.data.price) + '</p>';
