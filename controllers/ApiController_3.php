    ...
    public function actionGetsearchresult($callback = null) {
        ...
        $connection = Yii::$app->db;
            if($location){
                ...
                $query  = "SELECT `id`,`name`,`propertyid`,`location`,`city`,`path`,`persquarefeet`,`propertyarea`,`neworold`,`ownername`,`landmark`,`ameneties`,`expectedprice`,`resellrent`,`shoporoffice`,`typeofproperty`,`selectproperty`,`selecttype`,`status` from searchproperty "
